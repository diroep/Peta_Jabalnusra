...
map.getView().fit([11953442.698462, -1346674.668174, 14216632.239523, -63211.831749], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Wilayah Kerja BPTH3</h2>';
        return titleElement;
    })(),
